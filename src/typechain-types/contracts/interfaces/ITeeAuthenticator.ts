...
export interface ITeeAuthenticatorInterface extends Interface {
  getFunction(
    nameOrSignature: "checkSignature" | "getPubSecp521r1" | "getTeeSigner"
  ): FunctionFragment;
...
export interface ITeeAuthenticator extends BaseContract {
  connect(runner?: ContractRunner | null): ITeeAuthenticator;
  waitForDeployment(): Promise<this>;

  interface: ITeeAuthenticatorInterface;
